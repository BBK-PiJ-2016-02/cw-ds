public class FunctionalLinkedListTest {
	...
	public static void main(String[] args) {
		FunctionalLinkedList funcArrayList1 = new FunctionalLinkedList();
		funcArrayList1.add("Jack");
		funcArrayList1.add("Jill");
		funcArrayList1.add("Jane");
		System.out.println("funcArrayList1.size() should return 3: " + funcArrayList1.size());
		System.out.println("funcArrayList1.head().getReturnValue() should return \"Jack\": " + funcArrayList1.head().getReturnValue());
		System.out.println("funcArrayList1.rest().size() should return 2: " + funcArrayList1.rest().size());
